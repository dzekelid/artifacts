...
- name: AWS Service Catalog API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/artifacts/master/_listings/aws-service-catalog/action-updateprovisioningartifact-get.md
- name: AWS Service Catalog API Describe Provisioning Artifact
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/artifacts/master/_listings/aws-service-catalog/action-describeprovisioningartifact-get.md
x-common:
